      ...
      .expect(200, (err, response) => {
        if (err) {
          ...
          animals.forEach((animal) => {
            ...
            expect(animal.animals_name).toBeDefined();
...
const postAnimal = (
  ...
  return new Promise((resolve, reject) => {
    request(app)
      .post('/api/v1/animals')
      .send({animals_name, species, birthdate, location})
      .expect(201, (err, response) => {
        if (err) {
          ...
          expect(data.animals_name).toBe(animals_name);
...
const putAnimal = (
  ...
  return new Promise((resolve, reject) => {
    request(app)
      ...
      .send({animals_name, birthdate, location})
      .expect(200, (err, response) => {
        if (err) {
          reject(err);
        } else {
